...
package cn.thinkjoy.qky.classgroup.dao.biz;
 ...
 * @author linyuewei
 */
public interface IBizNoticeDAO extends IQkyBaseDAO<BizNotice> {
    List<BasUserEx> fetchNoticeRelUser(@Param("id") Long id);
}
