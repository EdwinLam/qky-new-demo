 ...
 * @author linyuewei
 */
public interface IBizMessageService<D extends IQkyBaseDAO<T>, T extends BaseDomain> extends IQkyBaseService<D, T>, IPageService<D, T> {
    /**
     * 增加信息
     *
     * @param curUser
     ...
     * @return
     */
    BizMessage addMessage(BasUser curUser, QkyCreateBaseDomain item);
}
