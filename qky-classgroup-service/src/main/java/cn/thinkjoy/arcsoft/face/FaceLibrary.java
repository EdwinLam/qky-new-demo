package cn.thinkjoy.arcsoft.face;

import cn.thinkjoy.arcsoft.face.bean.AgeInfo;
import cn.thinkjoy.arcsoft.face.bean.Face3DAngle;
import cn.thinkjoy.arcsoft.face.bean.FaceFeature;
import cn.thinkjoy.arcsoft.face.bean.GenderInfo;
import cn.thinkjoy.arcsoft.face.bean.MultiFaceInfo;
import cn.thinkjoy.arcsoft.face.bean.SingleFaceInfo;
import cn.thinkjoy.arcsoft.face.bean.Version;
...
public interface FaceLibrary extends Library {
	...
	FaceLibrary INSTANCE = Native.loadLibrary("libarcsoft_face_engine", FaceLibrary.class);
	 ...
	 * @param sdkKey
	 *            [in] 官网获取的SDKKEY
	 * @return 成功返回MOK，失败返回错误码，参考{@link cn.thinkjoy.arcsoft.face.enums.ErrorCode}
	 */
	 ...
	 *            <li>参考{@link cn.thinkjoy.arcsoft.face.enums.DetectMode}</li>
	 * @param detectFaceOrientPriority
	 *            [in]
	 *            检测脸部的角度优先值，参考：{@link cn.thinkjoy.arcsoft.face.enums.OrientPriority},
	 *            {@link cn.thinkjoy.arcsoft.face.enums.OrientCode}
