...
import cn.ripple.face.bean.AgeInfo;
import cn.ripple.face.bean.Face3DAngle;
import cn.ripple.face.bean.FaceFeature;
import cn.ripple.face.bean.GenderInfo;
import cn.ripple.face.bean.MultiFaceInfo;
import cn.ripple.face.bean.SingleFaceInfo;
import cn.ripple.face.bean.Version;
...
public interface FaceLibrary extends Library {
	 ...
	 * @param sdkKey
	 *            [in] 官网获取的SDKKEY
	 * @return 成功返回MOK，失败返回错误码，参考{@link cn.ripple.face.enums.ErrorCode}
	 */
	 ...
	 *            <li>参考{@link cn.ripple.face.enums.DetectMode}</li>
	 * @param detectFaceOrientPriority
	 *            [in]
	 *            检测脸部的角度优先值，参考：{@link cn.ripple.face.enums.OrientPriority},
	 *            {@link cn.ripple.face.enums.OrientCode}
