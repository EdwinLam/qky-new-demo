 ...
 * @author linyuewei
 */
public class EnrollReceive extends QkyCreateBaseDomain<Long> {
    private static final long serialVersionUID = 1L;

    private Long groupId; //分组id
    private Long enrollId; //报名的id
    ...
    public boolean equals(Object obj) {
        if (obj instanceof EnrollReceive == false) return false;
        if (this == obj) return true;
        EnrollReceive other = (EnrollReceive) obj;
