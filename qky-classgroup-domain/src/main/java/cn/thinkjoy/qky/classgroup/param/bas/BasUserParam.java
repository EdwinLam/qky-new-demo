 ...
 * @author linyuewei
 */
public class BasUserParam extends CreateBaseParam<Long> {
     ...
     * 字段常量——开放平台的唯一标识符
     */
    public static final String F_Unionid = "unionid";
    /**
     * 字段常量——用户昵称
     */
    public static final String F_NickName = "nickName";
    /**
     * 字段常量——用户头像，最后一个数值代表正方形头像大小（有0、46、64、96、132数值可选，0代表640*640正方形头像），用户没有头像时该项为空。若用户更换头像，原有头像URL将失效。
     */
    public static final String F_AvatarUrl = "avatarUrl";
    /**
     * 字段常量——用户的性别，值为1时是男性，值为2时是女性，值为0时是未知
     */
    ...
    /**
     * 字段常量——用户绑定的手机号（国外手机号会有区号）
     */
    public static final String F_PhoneNumber = "phoneNumber";
    /**
     * 字段常量——没有区号的手机号
     */
    public static final String F_PurePhoneNumber = "purePhoneNumber";
    /**
     * 字段常量——
     */
    public static final String F_CountryCode = "countryCode";

    private Long openid; //用户唯一标识
