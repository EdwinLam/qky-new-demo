        ...
        if (StrUtil.isNotBlank(token)) {
            ...
            try {
                ...
                if(StrUtil.isNotBlank(username)) {
                    ...
                    BasUserEx basUserEx = new Gson().fromJson(json, BasUserEx.class);
                    return new UsernamePasswordAuthenticationToken(basUserEx, null, new ArrayList<>());
                }
            } catch (ExpiredJwtException e) {
                throw new BizException(ErrorCodeEnum.PARAM_ERROR.getCode(), "超时");
            } catch (Exception e){
                throw new BizException(ErrorCodeEnum.PARAM_ERROR.getCode(), "超时");
            }
        }
